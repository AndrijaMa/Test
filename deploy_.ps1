...
func_Download -github_url $github_url -folder $folder -reg_file $reg_file -iDP_config $iDP_config -log_file $log_file  -event_file $event_file -version_major $major -version_minor $minor -version_hotfix $hotfix
func_Install -folder $folder -log_file $log_file
